<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="managefeedback.aspx.cs" Inherits="smartshop.managefeedback" %>
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="feedbackid" runat="server" placeholder="feedbackID"></asp:TextBox>
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-6">
                        <label>feedback </label>
                         <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="feedback" runat="server" placeholder="feedback" > </asp:TextBox>
                        </div>
                     </div>
                        ...
                        <label>Reply</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="replay" runat="server" placeholder="reply" > </asp:TextBox>
                        </div>
         ...
         <div class="col-md mx-auto">
            <div class="card">
               <div class="card-body">
                 ...
                 <div class="row">
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:smartshopConnectionString %>" SelectCommand="SELECT * FROM [feedback]"></asp:SqlDataSource>
                   
                     <div class="col">
                         <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="feedback_id" DataSourceID="SqlDataSource1" Width="228px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" >
                             <Columns>
                                 ...
                                 <asp:TemplateField HeaderText="Image">
                                     <ItemTemplate>
                                         <asp:Image ID="Image2" Width="40%" runat="server" ImageUrl='<%# Eval("image") %>' />
                                     </ItemTemplate>
                                 </asp:TemplateField>
