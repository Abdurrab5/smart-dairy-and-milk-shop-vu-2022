<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="shopmanageorder.aspx.cs" Inherits="smartshop.shopmanageorder" %>
         ...
         <div class="col-md-10 mx-auto">
            <div class="card">
               <div class="card-body">
                 ...
                 <div class="row">
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:smartshopConnectionString %>" SelectCommand="SELECT * FROM [orders] WHERE ([shop_id] = @shop_id)">
                         <SelectParameters>
                             <asp:ControlParameter ControlID="DropDownList1" Name="shop_id" PropertyName="SelectedValue" Type="String" />
                         </SelectParameters>
                     </asp:SqlDataSource>
