...
namespace smartshop
{
    public partial class complain : System.Web.UI.Page
    {
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("INSERT INTO complain(order_id,user_id,product_id,product_name,image,shop_id,complain) values(@order_id,@user_id,@product_id,@product_name,@image,@shop_id,@complain)", con);
            ...
            cmd.Parameters.AddWithValue("@complain", description.Text.Trim());


            cmd.ExecuteNonQuery();
            con.Close();

            Response.Write("<script>alert('complain Successful.');</script>");
