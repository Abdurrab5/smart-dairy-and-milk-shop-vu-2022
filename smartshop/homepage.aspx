<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="homepage.aspx.cs" Inherits="smartshop.homepage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div style="background-image:url('images/img1.jpg');width:100%;height:250px;background-repeat:no-repeat;">  </div>
     <br />
         ...
         <div class="col-md mx-auto">
            <div class="card align-content-center">
               <div class="card-body">
                ...
                CellPadding="3" BorderStyle="None" CellSpacing="2" GridLines="Both" DataSourceID="SqlDataSource1" OnItemDataBound="DataList1_ItemDataBound">
                    ...
                    <table class="table" >
                        <tr>
                            <td style="text-align: center">
                                <asp:Image ID="Image2" runat="server"  width="80%" CssClass="img" ImageUrl='<%#Eval("image") %>' />
                            </td>
                        </tr>
                         <tr>
                            <td>
         ...
         <div class="col-md mx-auto">
            <div class="card align-content-center">
               <div class="card-body">
                 ...
                 <div class="row ">
                     <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:smartshopConnectionString %>" SelectCommand="SELECT * FROM [shop]">
                     </asp:SqlDataSource>
                ...
                BackColor="#DEBA84" BorderColor="#DEBA84" BorderWidth="1px" 
                CellPadding="3" BorderStyle="None" CellSpacing="2" GridLines="Both" DataSourceID="SqlDataSource2">
                <FooterStyle BackColor="#F7DFB5" ForeColor="#8C4510" />
                <HeaderStyle BackColor="#A55129" Font-Bold="True" ForeColor="White" />
                <ItemStyle CssClass="igrid" BackColor="#FFF7E7" ForeColor="#8C4510" />
                <ItemTemplate>
                    <table class="table" >
                        ...
                        <tr>
                            <td>
                               Shop Name :
                                <asp:Label ID="Label1" runat="server" Text='<%#Eval("shop_name") %>'></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                              Shop Address :
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%#Eval("shop_id") %>'>View..</asp:LinkButton>
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
